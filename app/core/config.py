...
def _apply_interview_configs():
    ...
    global INFOSPOKE_S3_BUCKET_NAME, SQS_ANALYZE_IMAGE_QUEUE_URL, INTERVIEW_FRONTEND, ADMIN_FRONTEND
    ...
    INTERVIEW_FRONTEND = cache.get("INTERVIEW_FRONTEND", INTERVIEW_FRONTEND)
    ADMIN_FRONTEND = cache.get("ADMIN_FRONTEND", ADMIN_FRONTEND)
    BASE_URL = INTERVIEW_FRONTEND
    ...
    LINKEDIN_CLIENT_ID = cache.get("LINKEDIN_CLIENT_ID", LINKEDIN_CLIENT_ID)
    LINKEDIN_CLIENT_SECRET = cache.get("LINKEDIN_CLIENT_SECRET", LINKEDIN_CLIENT_SECRET)
    LINKEDIN_REDIRECT_URI = cache.get("LINKEDIN_REDIRECT_URI", LINKEDIN_REDIRECT_URI)
...
INTERVIEW_FRONTEND: str = None
ADMIN_FRONTEND: str = None
PORT: str = None
