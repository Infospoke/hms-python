...
class Client(GeminiClient):
    ...
    def _create_fallback_analysis(self, response: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "tb_matching_skills": [messages.UNABLE_TO_PARSE],
            "tb_missing_skills": [messages.UNABLE_TO_PARSE],
            "tb_matching_experience": [messages.UNABLE_TO_PARSE],
            "tb_experience_gaps": [messages.UNABLE_TO_PARSE],
            "tb_education_highlights": [messages.UNABLE_TO_PARSE],
            "tb_strengths": [messages.ANALYSIS_PARSING_FAILED],
            "tb_weaknesses": [messages.MANUAL_REVIEW_REQUIRED],
            "growth_potential": fallback_score,
            "tb_cultural_fit_indicators": [messages.UNABLE_TO_ASSESS],
